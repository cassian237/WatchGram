...
import 'package:watchgram/src/common/tdlib/extensions/message/sender.dart';
import 'package:watchgram/src/common/tdlib/extensions/message/strings/content.dart';
import 'package:watchgram/src/common/tdlib/extensions/message/strings/push.dart';
import 'package:watchgram/src/common/tdlib/extensions/misc/file.dart';
...
const String kMentionIcon = "@mipmap/ic_launcher";
const String kChatIcon = "@mipmap/ic_launcher";
const String kLogoIcon = "@mipmap/ic_launcher";
  ...
  Future<AndroidNotificationDetails> getDetails({
    ...
    return switch (type) {
      td.NotificationGroupTypeSecretChat() => AndroidNotificationDetails(
          channelByType,
          channelDescByType,
          groupKey: "clapps.be.watchgramnew.SECRET_CHATS_$chatId",
          icon: kChatIcon,
          largeIcon: largeIcon,
          when: when,
          playSound: playSound,
      ...
      td.NotificationGroupTypeCalls() => AndroidNotificationDetails(
          channelByType,
          channelDescByType,
          groupKey: "clapps.be.watchgramnew.CALLS_$chatId",
          icon: kChatIcon,
          largeIcon: largeIcon,
          when: when,
          playSound: playSound,
      ...
      td.NotificationGroupTypeMentions() => AndroidNotificationDetails(
          channelByType,
          channelDescByType,
          groupKey: "clapps.be.watchgramnew.MENTIONS_$chatId",
          icon: kMentionIcon,
          largeIcon: largeIcon,
          when: when,
          playSound: playSound,
      ...
      td.NotificationGroupTypeMessages() => AndroidNotificationDetails(
          channelByType,
          channelDescByType,
          groupKey: "clapps.be.watchgramnew.MESSAGES_$chatId",
          icon: kChatIcon,
          largeIcon: largeIcon,
          when: when,

...
import 'package:watchgram/src/components/icons/svg.dart';
...
import 'package:watchgram/src/pages/home/settings/user.dart';
        ...
        child: HandyScrollbar(
          ...
          child: ListView(
            ...
            children: [
              ...
              Text(
                "Watchgram ${Settings().currentVersion} (${Settings().currentCodename})",
